...
class PoliceSignUpPage extends StatefulWidget {
  const PoliceSignUpPage({super.key});

  @override
  State<PoliceSignUpPage> createState() => _PoliceSignUpPageState();
}

class _PoliceSignUpPageState extends State<PoliceSignUpPage> {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Establish unit identity and command access for secure dispatch protocols.",
                ...
                _buildField(hint: "Operational Area", controller: area, icon: Icons.explore_outlined),
                
                const SizedBox(height: 24),
                _sectionTitle("AUTHENTICATION"),
                _buildField(hint: "Unit Username", controller: username, icon: Icons.badge_outlined),
                _buildField(
